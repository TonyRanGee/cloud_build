package com.qzr.rabbit_server.config;
...
public class RabbitConfig {
     ...
     */
    public static final String EXCHANGE_A = "directExchange";
    public static final String EXCHANGE_B = "directExchangeB";
    public static final String EXCHANGE_C = "my-mq-exchange_C";
    public static final String FANOUT_EXCHANGE = "my-mq-fanout_exchange";
    public static final String DIRECT_EXECHANGE="my-mq-direct_change";
